...
![Template Method](https://raw.githubusercontent.com/Aurelius84/CocoTech/master/design_patterns/img/template_method.jpeg)
...
2. **适用场景**
    ...
    - 各子类中公共的行为应被提取出来并集中到一个公共父类中以避免代码重复。这是Opdyke 和Johnson所描述过的“重分解以一般化”的一个很好的例子
    - 控制子类扩展
